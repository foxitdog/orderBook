...
public class AddressBook {
	...
	private static final String[] columnNames = { resAddressBook.getString("Last_name"),
			resAddressBook.getString("First_name"), resAddressBook.getString("Business_phone"),
			resAddressBook.getString("Home_phone"), resAddressBook.getString("Email"),
	...
	/**
	 * Converts an encoded <code>String</code> to a String array representing a
	 * table entry.
	 */
	...
	private void openAddressBook() {
		...
		if (!file.exists()) {
			displayError(resAddressBook.getString("File") + file.getName() + " "
	...
	private boolean saveAs() {
		...
		if (file.exists()) {
			...
			box.setMessage(resAddressBook.getString("File") + file.getName() + " "
	...
	/**
	 * Creates all the items located in the File submenu and associate all the menu
	...
	private void createFileMenu(Menu menuBar) {
		...
		item.setMenu(menu);
		/**
		 * Adds a listener to handle enabling and disabling some items in the Edit
		 * submenu.
		 */
	...
	/**
	 * Creates all the items located in the Edit submenu and associate all the menu
	 * items with their appropriate functions.
	 *
	 * @param menuBar
	...
	private MenuItem createEditMenu(Menu menuBar) {
		...
		/**
		 * Add a listener to handle enabling and disabling some items in the Edit
		 * submenu.
		 */
		menu.addMenuListener(new MenuAdapter() {
			public void menuShown(MenuEvent e) {
	...
	/**
	 * Creates all the items located in the Sort cascading submenu and associate all
	 * the menu items with their appropriate functions.
	 *
	...
	/**
	 * Creates all items located in the popup menu and associates all the menu items
	...
	/**
	 * Creates all the items located in the Help submenu and associate all the menu
	 * items with their appropriate functions.
	 *
	 * @param menuBar
	...
	private class RowComparator implements Comparator {
		 ...
		 * @return negative if obj1 less than obj2, positive if obj1 greater than obj2,
		 *         and zero if equal.
		 */
